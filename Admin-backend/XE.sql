...
GRANT CONNECT, RESOURCE TO urbanfood;
...
VALUES ('ABC Suppliers', 'New York');

-- Insert Products
INSERT INTO products (name, category, price, supplier_id) 
VALUES ('Apple', 'Fruits', 1.50, 1);

-- Insert Orders
-- Remember: now customer_id=1 exists (John Doe)
INSERT INTO orders (customer_id, total_amount, status) 
VALUES (1, 15.00, 'Pending');

-- Insert Order Items
-- Correct order_id and product_id
...
-- 4. SELECT Queries to Check

-- Select all orders with customer names
SELECT o.id, c.name AS customer_name, o.order_date, o.total_amount, o.status 
FROM orders o 
JOIN customers c ON o.customer_id = c.id;

-- Select products and their suppliers
